...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center">
        <h2 class="mt-4 text-dark fw-bold">Prorrateo por Terceros</h2>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-dark text-white d-flex justify-content-between">
            ...
            <span class="small">Ref: {{ $asiento->Referencia }}</span>
        </div>
        <div class="card-body">
            <div class="row align-items-end">
                <div class="col-md-6">
                    <label class="fw-bold text-muted">Línea del Asiento seleccionada:</label>
                    <select id="select_detalle" class="form-select mt-1" disabled>
                ...
                <div class="col-md-6 text-end">
                    <h4 class="mb-0 text-dark fw-bold">
                        Monto a Distribuir: 
                        <span id="display_monto_objetivo">₡{{ number_format($detalle->Monto, 2) }}</span>
                    </h4>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-light fw-bold">2. Asignar Tercero</div>
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label">Tercero</label>
                        <select id="select_tercero" class="form-select">
                    ...
                    <button type="button" id="btn_ejecutar_agregado" class="btn btn-dark w-100 shadow-sm">
            ...
            <form action="{{ route('prorrateo.guardar') }}" method="POST">
                                ...
                                <tbody id="tabla_prorrateo">
                                    <tr>
                                        <td colspan="5" class="text-center text-muted py-4">
                                            Agregue terceros para comenzar
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="card-footer bg-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="text-start">
                                ...
                                <span id="diferencia_pendiente" class="fw-bold text-warning">
                ...
                <div class="text-end mt-3">
                    <button type="submit" id="btn_guardar" class="btn btn-dark btn-lg px-5 shadow" disabled>
                        <i class="bi bi-save me-1"></i> Guardar Distribucion
                    </button>
                </div>
            ...
            html += `
                <tr>
                    ...
                    <td class="text-center">
                        <button type="button"
                                onclick="GestorProrrateo.eliminar(${index})"
