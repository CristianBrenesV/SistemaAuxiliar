...
<h5 class="mb-0">Reporte de Movimientos por Centro de Costo</h5>
</div>
...
<select name="centro_id" class="form-select form-select-sm">

<option value="">Todos</option>

@foreach($centros as $c)

<option value="{{ $c->IdCentroCosto }}"
{{ request('centro_id') == $c->IdCentroCosto ? 'selected' : '' }}>
{{ $c->Nombre }}
</option>
...
<a href="{{ route('reportes.centros') }}" class="btn btn-outline-secondary btn-sm">
Limpiar filtros
</a>
